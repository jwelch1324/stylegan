...
res = ipd.ImagePatchDatabase(patch_width=400,patch_height=400)


# In[5]:


loader = torch.utils.data.DataLoader(res,batch_size=5,shuffle=True)
...
solver = ag.PatchGANSolver2(loader,config)
